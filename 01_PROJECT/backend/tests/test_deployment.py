...
PRODUCT_ROOT = BACKEND.parent                    # 01_PROJECT/
# docker-compose.yml stays at the REPOSITORY root, not inside 01_PROJECT/,
# because the `full` image does `COPY 03_RESEARCH/pipeline /research/pipeline`
# — a build context rooted at 01_PROJECT/ could not reach the research tree.
