...
ROOT = Path(settings.project_root)                      # 03_RESEARCH/
# The frozen-champion bundle (manifest + the two binaries it certifies) is
# provenance documentation, so it lives under 02_DOCUMENTATION/ rather than in
# the research tree the API points at.
MANIFEST = (ROOT.parent / "02_DOCUMENTATION" / "02_MODEL" / "FROZEN_CHAMPION"
