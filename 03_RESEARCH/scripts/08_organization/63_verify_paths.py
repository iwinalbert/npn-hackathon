...
OUT = (ROOT.parent / "02_DOCUMENTATION" / "09_VALIDATION" / "_integrity"
...
def main():
    ...
    # The canonical artefacts live here in 03_RESEARCH/; the curated copies are
    # documentation, one level up in 02_DOCUMENTATION/. `03_FORECASTS/` and
    ...
    DOCS = ROOT.parent / "02_DOCUMENTATION"
    pairs = [
