 ...
 *
 *   data → selection → forecast → aggregation → accuracy → validation
 *        → decision support → model → methodology
 *
...
const NAV = [
  ...
  },
  {
    group: 'Evidence',
    items: [
      { to: '/accuracy', label: 'Accuracy', desc: 'Measured performance' },
      { to: '/validation', label: 'Validation', desc: 'Predicted vs actual, historical windows' },
    ],
  },
  {
    group: 'How it works',
    items: [
      { to: '/model', label: 'Model', desc: 'Architecture and live verification' },
      { to: '/methodology', label: 'Methodology', desc: 'Data, limits, what was rejected' },
    ],
  },
]
