...
```bash
cd <project root>
python tasks.py build-db                  # if 06_BACKEND/data is empty
...
research artefacts. All frontend work is confined to `07_FRONTEND/`, with the two
additive backend endpoints in `06_BACKEND/app/` and this report in
`08_DOCUMENTATION/`.
